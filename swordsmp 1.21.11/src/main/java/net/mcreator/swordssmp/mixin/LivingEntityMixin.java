...
import net.mcreator.swordssmp.event.LivingEntityEvents;
...
public abstract class LivingEntityMixin {
	...
	public void dropExperience(ServerLevel serverLevel, Entity entity, CallbackInfo ci) {
		...
		if (!self.wasExperienceConsumed()
				&& (this.isAlwaysExperienceDropper() || this.lastHurtByPlayerMemoryTime > 0 && self.shouldDropExperience()
							&& Boolean.TRUE.equals(serverLevel.getGameRules().get(GameRules.MOB_DROPS)))) {
