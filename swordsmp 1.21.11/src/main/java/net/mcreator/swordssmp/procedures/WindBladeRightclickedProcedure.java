...
public class WindBladeRightclickedProcedure {
	...
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity instanceof Player) {
			System.out.println("[WindBlade] Right-click detected. WindBladeCooldown=" + entity.getAttachedOrCreate(SwordssmpModVariables.PLAYER_VARIABLES).WindBladeCooldown + ", Djump=" + entity.getAttachedOrCreate(SwordssmpModVariables.PLAYER_VARIABLES).Djump);
		}
		...
		if (entity.getAttachedOrCreate(SwordssmpModVariables.PLAYER_VARIABLES).WindBladeCooldown == 0) {
			if (entity.getAttachedOrCreate(SwordssmpModVariables.PLAYER_VARIABLES).Djump == 0) {
				if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == SwordssmpModItems.WIND_BLADE) {
					entity.push(0, 1, 0);
					...
					if (world instanceof ServerLevel _level) {
						_level.getServer().getCommands().performPrefixedCommand(_level.getServer().createCommandSourceStack().withSuppressedOutput(),
					...
					}
					{
						...
						_vars.Djump = entity.getAttachedOrCreate(SwordssmpModVariables.PLAYER_VARIABLES).Djump + 1;
						_vars.markSyncDirty();
					}
				}
			} else if (entity.getAttachedOrCreate(SwordssmpModVariables.PLAYER_VARIABLES).Djump == 1) {
				if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == SwordssmpModItems.WIND_BLADE) {
					entity.push(0, 1, 0);
					if (world instanceof ServerLevel _level) {
						_level.sendParticles(ParticleTypes.CLOUD, x, y, z, 50, 1, 3, 1, 1);
			...
			} else if (entity.getAttachedOrCreate(SwordssmpModVariables.PLAYER_VARIABLES).Djump == 2) {
				if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == SwordssmpModItems.WIND_BLADE) {
					entity.push(0, 1, 0);
					if (world instanceof ServerLevel _level) {
						_level.sendParticles(ParticleTypes.CLOUD, x, y, z, 50, 1, 3, 1, 1);
			...
			} else if (entity.getAttachedOrCreate(SwordssmpModVariables.PLAYER_VARIABLES).Djump == 3) {
				if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == SwordssmpModItems.WIND_BLADE) {
					entity.push(0, 1, 0);
					if (world instanceof ServerLevel _level) {
						_level.sendParticles(ParticleTypes.CLOUD, x, y, z, 50, 1, 3, 1, 1);
			...
			} else if (entity.getAttachedOrCreate(SwordssmpModVariables.PLAYER_VARIABLES).Djump == 4) {
				if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == SwordssmpModItems.WIND_BLADE) {
			...
			} else if (entity.getAttachedOrCreate(SwordssmpModVariables.PLAYER_VARIABLES).WindBladeBautaReset == 0) {
				if (entity.getAttachedOrCreate(SwordssmpModVariables.PLAYER_VARIABLES).Djump == 4) {
					if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == SwordssmpModItems.WIND_BLADE) {
						if (world.getBlockState(BlockPos.containing(x, y - 1, z)).canOcclude()) {
							{
								SwordssmpModVariables.PlayerVariables _vars = entity.getAttachedOrCreate(SwordssmpModVariables.PLAYER_VARIABLES);
