...
public class PhantomBladeItem extends ShieldItem {
	public PhantomBladeItem(Item.Properties properties) {
		super(properties.repairable(TagKey.create(Registries.ITEM, Identifier.parse("swordssmp:phantom_blade_repair_items"))).component(DataComponents.BREAK_SOUND, SoundEvents.SHIELD_BREAK).equippableUnswappable(EquipmentSlot.OFFHAND)
